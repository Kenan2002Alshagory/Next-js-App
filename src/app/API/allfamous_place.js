...
export const getAllPlaces = async () => {
    const response = await APIEndpoint.get('/fam',{
        headers: {
                ...
                {places.map((place) => (
                    <>
                        ...
                        <div className="p-4 flex justify-around">
                            <div>        
                                <h4 className="ttitle-font text-lg font-medium text-green-400">Location : {place.location}</h4>
                            </div>
                            <div>
